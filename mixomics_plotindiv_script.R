...
parser$add_argument('--block_idx', dest='block_idx', type='integer', help="Index of the block to be plotted")
...
for(k in 1:length(res_block_splsda$names[[3]]))
{
